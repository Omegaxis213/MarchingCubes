...
export class GUI implements IGUI {
  ...
  public onKeydown(key: KeyboardEvent): void {
	...
	// TODO: Your code for key handling

    switch (key.code) {
      case "KeyW": {
        this.camera.offset(this.camera.forward().copy().negate(), GUI.zoomSpeed, true);
        break;
      }
      case "KeyA": {
        this.camera.offset(this.camera.right().copy().negate(), GUI.panSpeed, true);
        break;
      }
      case "KeyS": {
      ...
      case "ArrowDown": {
        this.camera.offset(this.camera.up().copy().negate(), GUI.panSpeed, true);
        break;
      }
      default: {
